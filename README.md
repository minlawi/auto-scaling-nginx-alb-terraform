...
* Update your profile in the **s3_bucket** folder as well

* Once the profile is updated in the **s3_bucket** folder, proceed to create the S3 bucket to store the Terraform state file.
<pre>cd s3_bucket/
terraform init
terraform validate
terraform plan
